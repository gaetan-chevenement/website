...
const captions = [
  ...
  { value: 'living-room', label: 'Séjour' },
  { value: 'dining-room', label: 'Salle à manger' },
  { value: 'building', label: 'Immeuble' },
  { value: 'cellar', label: 'Cellier' },
  { value: 'dressing', label: 'Dressing' },
  { value: 'room1', label: 'Chambre 1' },
  { value: 'room2', label: 'Chambre 2' },
  { value: 'room3', label: 'Chambre 3' },
  { value: 'room4', label: 'Chambre 4' },
  { value: 'room5', label: 'Chambre 5' },
  { value: 'room6', label: 'Chambre 6' },
  { value: 'room7', label: 'Chambre 7' },
  { value: 'room8', label: 'Chambre 8' },
  { value: 'room9', label: 'Chambre 9' },
];
