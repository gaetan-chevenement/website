...
export default { 'fr-FR': [
  ...
  ['Checkin à domicile - heures d\'ouverture', 'Du lundi au vendredi, de 9h  18h (hors jours fériés)',
                                                                  '79€', 1, 1],
  ['Checkin à domicile - 24/7', 'Soirée, nuits, week-ends et jours fériés inclus',
                                                             '149€', '79€', 1],
  ...
  ['Service bagagerie', 'Voyagez les mains libres en déposant vos bagages en agence (2 bag. pour 10j max.)',
                                                                 '129€', 1, 1],
  ['Tickets de transports x2', 'Valide pour toutes les lignes (metro, tram, bus)',
                                                                      0, 1, 1],
  ...
  ['Activation de services', 'Assurance habitation, assistance, wifi, eau, gaz, éléctricité…',
                                                                      1, 1, 1],
  ['Bail individuel', 'Même en collocation, indépendant & fléxible',  1, 1, 1],
  ['État des lieux individuel', 'Même en collocation, indépendant & fléxible',
                                                                      1, 1, 1],
  ['Mon séjour'],
  ...
  ['Check-out 24/7', 'Soirée, nuits, week-ends, jours fériés inclus', 0, 0, 1],
  ['Service bagagerie', 'Voyagez les mains libres en déposant vos bagages en agence (2 bag. pour 10j max.)',
                                                                 '129€', 1, 1],
